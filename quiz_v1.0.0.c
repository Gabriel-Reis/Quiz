...
* Versão Inicial do Quiz, com perguntas de dificuldades e temas variados
*
*/
...
void ra (char r){
    ...
    if (r == 'a')   /* RESPOSTA CERTA = +2 PONTOS */
        printf("\nResposta correta, Você ganhou 2 pontos!! \n\a\a"), score=score +2, acertos++, op=0, perg++;
    else if ((r == 'b')||(r == 'c')||(r == 'd'))  /* RESPOSTA ERRADA = -1PONTO */
        {
...
void rb (char r){
    r = tolower (r);   /*  MAIUSCULA = MINUSCULAS  */
    if (r == 'b')   /* RESPOSTA CERTA = +2 PONTOS */
        printf("\nResposta correta, Você ganhou 2 pontos!! \n\a\a"), score=score+2, acertos++, op=0, perg++;
    else if ((r == 'a')||(r == 'c')||(r == 'd'))/* RESPOSTA ERRADA = -1PONTO */
        {
        printf("\nResposta errada, Você perdeu 1 ponto! \n\a"), score--, erros++, op=0, perg++;
        feedback = 1;
        }
...
void rc (char r){
    r = tolower (r);   /*  MAIUSCULA = MINUSCULAS  */
    if (r == 'c')   /* RESPOSTA CERTA = +2 PONTOS */
        printf("\nResposta correta, Você ganhou 2 pontos!! \n\a\a"), score=score+2, acertos++, op=0, perg++;
    else if ((r == 'a')||(r == 'b')||(r == 'd'))/* RESPOSTA ERRADA = -1PONTO */
        {
        printf("\nResposta errada, Você perdeu 1 ponto! \n\a"), score--, erros++, op=0, perg++;
        feedback = 1;
        }
...
void rd (char r){
    r = tolower (r);   /*  MAIUSCULA = MINUSCULAS  */
    if (r == 'd')   /* RESPOSTA CERTA = +2 PONTOS */
        printf("\nResposta correta, Você ganhou 2 pontos!! \n\a\a"), score=score+2, acertos++, op=0, perg++;
    else if ((r == 'a')||(r == 'b')||(r == 'c'))  /* RESPOSTA ERRADA = -1PONTO */
        {
        printf("\nResposta errada, Você perdeu 1 ponto! \n\a"), score--, erros++, op=0, perg++;
        feedback = 1;
        }
...
void pontparc (void){
    ...
    system ("pause");                             /*  EXIBE A PONTUAÇÃO A O FINAL DA RESPOSTA  */
    system ("cls");                               /*                                           */
}
...
int main (void){
    ...
    char nome[25];                    /*         VETOR PARA INSERÇÃO DO NOME         */

    printf ("\n \t\t\tQuiz\n");                         /*                                      */
    printf ("Digite seu nome: ");                       /*                                      */
    scanf  ("%[^\n]s  ", nome);                         /*       APRESENTAÇÃO DO JOGADOR        */
    system ("cls");                                     /*                                      */

    printf ("\n \t\t\tQuiz\n");
    printf ("\n\n\n\n\n   Olá %s, seja bem vindo ao jogo de quiz"), nome;            /*                                */
    printf ("\n\n\n\n2 BEEP quando acertar uma pergunta e 1 beep quando errar.");    /*      APRESENTAÇÃO DO QUIZ      */
    printf ("\n\n\n\n\n\n\n\n\n\n\nO jogo iniciará em instantes!!");                 /*                                */
        int tempo = clock();                    /*                           */
            while (clock() - tempo < 4500);     /*     CONDIÇÃO DE TEMPO     */
            system ("cls");                     /*                           */
